        ...
        if pick_joint_path:
            ...
            for place_scene in place.get_possible_transitions(scene=pick_scene, action=place_action):
                ...
                if ik_solve:
                    ...
                    if place_joint_path:
                        pick_action_2 = pick.get_action_level_1_for_single_object(scene_mngr.scene, "red_box")
                        for pick_scene_2 in pick.get_possible_transitions(place_scene, pick_action_2):
                            ...
                            if ik_solve:
                                ...
                                if pick_joint_path_2:
                                    pick_scene_2.objs["red_box"].h_mat = pick_scene_2.robot.gripper.pick_obj_pose
                                    place_action2 = place.get_action_level_1_for_single_object(pick_scene_2, "green_box", "red_box", pick_scene_2.robot.gripper.grasp_pose)
                                    for place_scene_2 in place.get_possible_transitions(scene=pick_scene_2, action=place_action2):
                                        ...
                                        if ik_solve:
                                            ...
                                            if place_joint_path2:
                                                pick_action_3 = pick.get_action_level_1_for_single_object(scene_mngr.scene, "blue_box")
                                                for pick_scene_3 in pick.get_possible_transitions(place_scene_2, pick_action_3):
                                                    ...
                                                    if ik_solve:
                                                        ...
                                                        if pick_joint_path_3:
                                                            pick_scene_3.objs["blue_box"].h_mat = pick_scene_3.robot.gripper.pick_obj_pose
                                                            place_action3 = place.get_action_level_1_for_single_object(pick_scene_3, "red_box", "blue_box", pick_scene_3.robot.gripper.grasp_pose)

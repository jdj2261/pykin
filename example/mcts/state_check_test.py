...
scene_mngr.scene.logical_states["D_box"] = {scene_mngr.scene.logical_state.on : scene_mngr.scene.objs["B_box"]}
scene_mngr.scene.logical_states["C_box"] = {scene_mngr.scene.logical_state.on : scene_mngr.scene.objs["D_box"]}

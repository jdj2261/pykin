...
scene_mngr.scene.logical_states["A_box"] = {scene_mngr.scene.state.on : scene_mngr.scene.objs["table"]}
scene_mngr.scene.logical_states["B_box"] = {scene_mngr.scene.state.on : scene_mngr.scene.objs["A_box"]}
scene_mngr.scene.logical_states["C_box"] = {scene_mngr.scene.state.on : scene_mngr.scene.objs["B_box"]}

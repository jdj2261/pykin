...
pnp = PnPManager(max_width=0.08, self_c_manager=c_manager, obstacle_c_manager=o_manager)
post_transforms, pre_transforms = pnp.get_all_grasp_transforms(robot, obj_mesh1, obs_pos1, 0.08, 0.05, 5)
...
pnp.visualize_robot(ax, robot, transforms, gripper_name, mesh_path, 0.3, False)
pnp.visualize_robot(ax, robot, pre_transforms, gripper_name, mesh_path,1, False)

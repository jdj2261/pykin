...
def get_pose_from_homogeneous(h_mat):
    ...
    orientation = get_quaternion_from_matrix(get_rot_mat_from_homogeneous(h_mat))
...
def get_quaternion(orientation, convention="wxyz"):
    ...
    if isinstance(orientation, (np.ndarray, list)):
        ...
        raise TypeError(
            "Expecting the given orientation to be a np.ndarray, quaternion, tuple or list, instead got: "

...
class ActivityBase(metaclass=ABCMeta):
    ...
    def get_mesh_surface_points(self, obj_name, n_sampling=100):
        copied_mesh = deepcopy(self.scene_mngr.objs[obj_name].gparam)
        copied_mesh.apply_transform(self.scene_mngr.objs[obj_name].h_mat)
        contact_points, _, normals = surface_sampling(copied_mesh, n_sampling)
    ...
    def render_points(self, ax, points):

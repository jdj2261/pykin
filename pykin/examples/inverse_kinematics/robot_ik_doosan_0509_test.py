...
robot = SingleArm(
    urdf_path, t_utils.Transform(rot=[0.0, 0.0, 0.0], pos=[0, 0, 0.0]), has_gripper=True
)
...
p_utils.plot_robot(ax=ax, robot=robot, geom="visual")
...
p_utils.plot_robot(ax=ax, robot=robot, geom="visual", visible_text=True)
p_utils.show_figure()
